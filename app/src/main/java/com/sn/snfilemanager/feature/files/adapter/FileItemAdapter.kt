...
import com.sn.snfilemanager.utils.KotlinExtension
...
class FileItemAdapter(
    ...
    inner class FileViewHolder(private val binding: ItemFileBinding) :
        ...
        fun bind(fileModel: FileModel) {
            ...
            binding.tvFileSize.text = fileModel.readableSize
    ...
    private fun getDirectoryIcon(name: String) =
        when (name) {
            DirectoryType.MUSIC.type -> R.drawable.ic_folder
            DirectoryType.MOVIES.type -> R.drawable.ic_folder
            DirectoryType.DOWNLOAD.type -> R.drawable.ic_folder
            DirectoryType.DOCUMENTS.type -> R.drawable.ic_folder
            DirectoryType.ANDROID.type -> R.drawable.ic_folder
            DirectoryType.PICTURES.type -> R.drawable.ic_folder
            DirectoryType.DCIM.type -> R.drawable.ic_folder
