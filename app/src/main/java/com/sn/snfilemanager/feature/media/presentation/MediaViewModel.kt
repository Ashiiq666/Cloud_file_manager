...
class MediaViewModel
    ...
    private fun getFilteredMediaTypes(): MutableSet<String>? =
        when (mediaType) {
            ...
            MediaType.FILES -> when (documentType) {
                DocumentType.ARCHIVE.name -> PrefsTag.FILTER_ARCHIVES
                DocumentType.DOWNLOAD.name -> PrefsTag.FILTER_DOWNLOADS // Add this line
                else -> PrefsTag.FILTER_DOCUMENTS
            }
            else -> null
    ...
    private fun getDocumentMime(): List<String>? {
        ...
        private fun getDocumentExtensions(): List<String> {
            return when (documentType) {
                ...
                DocumentType.DOWNLOAD.name -> MimeTypes.DOWNLOADS.values // Add this line
